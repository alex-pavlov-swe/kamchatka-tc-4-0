        ...
        <div className="col-lg-5 info">
            ...
            <div className="card">
                ...
                <div className="card card-body collapse" id="collapse-21">
                    <p>- проживание и питание в Петропавловске-Камчатском (дни 1 и 13)</p>
                    <p>- обеды в кафе (день 1 - в Петропавловске)</p>
            ...
            <i className="fas fa-chevron-down"></i>
                ...
                <div className="card card-body collapse" id="collapse-26">
                    <p>
                        На маршруте питание готовят сами участники в
