      ...
      <div className="card">
        <div className="card-header">
          <button
            ...
            onClick={e => togglePlusIcon(e)}
          >
            <i className="fas fa-plus mr-2"></i> День 12. Переезд к Мутновской
            геотермальной электростанции, пешая экскурсия к Дачным термальным
            источникам, к вечеру возвращение в город.
          </button>
        </div>
        <div className="card card-body collapse" id="collapse-12">
          <p>
            <img
              ...
              alt="Камчатка с Севера на Юг"
            />
            Дачные горячие источники иногда называют «Малой Долиной Гейзеров» -
            это активное фумарольное поле, горячие газы которого проходят сквозь
            воду холодного ручья, нагревая его и создвая эффект фонтанирования в
            ряде случаев.
          </p>
          <p>
            Абсолютная высота Мутновского - 2323м, один из крупнейших вулканов
